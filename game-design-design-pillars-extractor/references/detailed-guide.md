...
### Map the dominant design behaviors
Look at:
- core loop
- repeat decisions
- reward structure
...
### Detect tradeoffs and contradictions
...
### Identify missing or weak pillars
Ask:
...
### Turn the pillars into decision guidance
State:
