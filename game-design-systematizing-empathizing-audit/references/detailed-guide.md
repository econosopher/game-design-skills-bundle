...
Read `axis-definitions.md` when judging the two axes.
Read `quadrant-reads.md` when describing what the position tends to feel like in practice.
Read `persona-tendencies.md` when mapping likely audience appeal and rejection.
...
### Read the design at the player-experience level
Clarify:
