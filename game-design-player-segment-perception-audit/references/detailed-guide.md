...
Read `segment-layers.md` when mapping the main audience groups.
Read `perception-failures.md` when diagnosing common update-perception mistakes.
Read `recommendation-patterns.md` when deciding how to adjust targeting, access, or messaging.
...
### Clarify the feature and its intended audience
Ask:
...
### Audit visibility versus access
Check:
...
### Recommend a better segment strategy
Possible moves:
...
A feature is not experienced only by the players who use it.
It is also experienced by the players who see it, anticipate it, misunderstand it, or discover they are excluded from it.
