...
Read `value-types.md` when identifying what kind of value the feature creates.
Read `blind-spot-patterns.md` when diagnosing common KPI-coverage failures.
Read `recommendation-patterns.md` when deciding how to justify or evaluate hard-to-measure work.
...
### Identify the role of the feature
...
### Identify the current KPI story
Ask:
