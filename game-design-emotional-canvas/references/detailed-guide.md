...
### Describe the emotional texture
...
### Identify emotional anti-patterns
...
### Turn the feeling into heuristics
...
### Evaluate the concept holistically
...
- `examples.md` for sample emotional targets and example emotional fields
- `prompts.md` for extra workshop-style prompts and facilitation questions
