...
Read `quadrants-and-hiding-places.md` when you need examples of each quadrant or a list of common hiding places for unknown unknowns.
...
### Convert fog into prototype questions
...
Read `prototype-question-patterns.md` when you want more examples of strong versus weak prototype questions.

Write:
- **Prototype questions**

### Identify the right prototype type
...
Read `prototype-types.md` when you need examples of what each type is best at exposing.

### Sequence prototypes as a branching map
...
Read `anti-patterns.md` for common prototyping failure modes and how to spot them.

### Specify stop criteria
