...
Read `method-selection.md` when choosing a method.
Read `method-patterns.md` when you need the exact structure for a method output.
...
### Convert brainstorm into action
