...
Read `role-patterns.md` when you need common role groupings and substitution patterns.
Read `minimum-team-shapes.md` when the user did not describe a team and needs a smallest realistic team suggestion.
