...
### Decide whether reframing is appropriate at all
...
### Diagnose the dominant stagnation pattern
...
### Choose a reframe strategy

Use one or combine several:

#### Role reframe
Shift who the player is right now.
Examples:
- builder -> optimizer
- collector -> curator
- attacker -> steward
...
#### Social reframe
Redefine the current state through comparison, contribution, or recognition.
Examples:
- show off efficiency
- mentor others
...
### Generate multiple plausible reframes
