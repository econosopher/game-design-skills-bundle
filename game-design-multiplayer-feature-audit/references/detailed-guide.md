...
### Audit time model and synchronization demands
...
### Audit depth of social interaction
...
### Audit fit for mostly single-player games
...
- `social-design-dimensions.md` for the deeper multiplayer audit checklist and sharper prompts
