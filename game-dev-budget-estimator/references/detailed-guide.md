...
Read `cost-drivers.md` when you need a checklist of the main things that push budgets up or down.
Read `estimation-modes.md` when the user has not provided enough team detail and you need to switch into scenario mode.
