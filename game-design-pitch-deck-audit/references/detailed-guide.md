...
### Audit the high-level structure
...
### Audit the team and credibility section
Ask:
...
### Audit deck usability and readability
Ask:
...
- `pitch-deck-notes.md` for distilled deck structure and slide expectations from the templates
- `raw-fury-notes.md` for the Raw Fury-specific pitch expectations
