...
Read `team-size-guidance.md` when team composition strongly affects the answer.
Read `development-order.md` when you need a default build order or beginner-safe sequencing.
